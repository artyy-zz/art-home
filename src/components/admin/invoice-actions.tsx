...
import { deleteInvoiceAction, updateInvoiceAction } from "@/actions/admin";
...
type InvoiceStatusKey = keyof typeof statusLabels.sq;
  ...
  return (
    <>
      <div className="inline-flex flex-wrap items-center justify-end gap-2">
        ...
        {canDelete ? (
          <form action={deleteInvoiceAction.bind(null, locale, invoice.id)}>
            <ConfirmDeleteButton
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 px-4 py-6">
          <div className="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-[28px] border border-black/10 bg-[#fbf8f4] p-5 shadow-[0_28px_80px_rgba(0,0,0,0.28)]">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h3 className="font-display text-3xl leading-none text-[var(--color-foreground)]">
                  {locale === "sq" ? "Ndrysho faturen" : "Edit invoice"}
                </h3>
